        ...
        <header className="w-full py-4 px-6 bg-white border-b border-slate-200 sticky top-0 z-50">
            <div className="max-w-7xl mx-auto flex items-center justify-between">
                ...
                <nav className="hidden md:flex items-center space-x-1">
                    ...
                    <Link
                        to="/faq"
                        className={`px-3 py-1.5 text-sm font-medium rounded transition-colors ${isActive('/faq')
                            ? 'text-slate-900 bg-slate-100'
                            : 'text-slate-700 hover:text-slate-900 hover:bg-slate-100'
                            }`}
                    >
                    ...
                    <Link
                        to="/pricing"
                        className={`px-3 py-1.5 text-sm font-medium rounded transition-colors ${isActive('/pricing')
                            ? 'text-slate-900 bg-slate-100'
                            : 'text-slate-700 hover:text-slate-900 hover:bg-slate-100'
                            }`}
                    >
            ...
            {mobileMenuOpen && (
                <div className="md:hidden mt-4 pb-4 border-t border-slate-200 pt-4">
                    <nav className="flex flex-col space-y-2">
                        ...
                        <Link
                            to="/faq"
                            className={`px-3 py-2 text-sm font-medium rounded transition-colors ${isActive('/faq')
                                ? 'text-slate-900 bg-slate-100'
                                : 'text-slate-700 hover:text-slate-900 hover:bg-slate-100'
                                }`}
                            onClick={() => setMobileMenuOpen(false)}
                        ...
                        <Link
                            to="/pricing"
                            className={`px-3 py-2 text-sm font-medium rounded transition-colors ${isActive('/pricing')
                                ? 'text-slate-900 bg-slate-100'
                                : 'text-slate-700 hover:text-slate-900 hover:bg-slate-100'
                                }`}
                            onClick={() => setMobileMenuOpen(false)}
